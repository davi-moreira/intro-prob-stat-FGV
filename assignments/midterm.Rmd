...
6. What is the callback rate by first name? Which first name receives the highest and the lowest callback rates?
...
2. One researcher want to study tax conservatism among rich. She selects lotery ticket winners to run her study, and she claims that the biggest the ticket the person won, the more the person is against income taxes. Should we believe this study? What are the strenghts in this study? What are the weaknesses in this study?
